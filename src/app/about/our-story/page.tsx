...
const StoryPage = () => {
  return (
    <div className="flex grow flex-col items-center self-stretch overflow-x-hidden">
      ...
      <AnimatedSection animation="fade-in" className="About relative px-8 sm:px-48 py-20 flex flex-col sm:flex-row items-center justify-between bg-white gap-5 sm:gap-36 overflow-hidden">
        <FloatingElements variant="dots" density="low" />
        
        <div className="relative z-10 flex flex-col gap-6 max-w-lg fade-in-left">
      ...
      <AnimatedSection animation="slide-in-left" className="Mission relative px-8 sm:px-48 py-20 flex flex-col sm:flex-row items-center justify-between bg-gradient-to-br from-gray-50 via-white to-green-50/30 gap-5 sm:gap-36 overflow-hidden">
      ...
      <AnimatedSection animation="slide-in-right" className="Vision relative px-8 sm:px-48 py-20 flex flex-col sm:flex-row items-center justify-between bg-white gap-5 sm:gap-36 overflow-hidden">
        <FloatingElements variant="dots" density="low" />
      ...
      <AnimatedSection animation="fade-in" className="Timeline relative py-20 flex flex-col bg-gradient-to-br from-green-50 via-white to-gray-50 gap-8 sm:gap-16 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row gap-6 sm:gap-12 px-4 sm:px-12 fade-in-up stagger-2">
      ...
      <AnimatedSection animation="fade-in" className="Timeline relative py-20 flex flex-col bg-white gap-8 sm:gap-16 overflow-hidden">
        <FloatingElements variant="dots" density="low" />
         ...
         <div className="relative z-10 Header justify-center flex flex-col items-center gap-4 fade-in-up">
          ...
          <p className="text-xl text-gray-600 text-centermax-w-3xl mx-auto leading-relaxed">
      ...
      <AnimatedSection animation="fade-in" className="Team relative py-20 flex flex-col bg-gradient-to-br from-gray-50 via-white to-green-50/30 gap-8 sm:gap-16 overflow-hidden">
        <FloatingElements variant="shapes" density="low" />
