    ...
    return (
        <div className="relative flex h-[80vh] w-full items-center justify-end sm:h-[90vh]">
            <Image
                ...
                className="z-0"
            />
            <div className="absolute inset-0 flex flex-col items-start justify-center text-start text-white z-10 px-12 sm:px-36">
                <h1 className="mb-4 text-4xl font-semibold sm:text-6xl">
                    {titleText}
                </h1>
                <p className="mb-8 text-sm sm:text-lg font-secondary">
                    {subTitleText}
                </p>
            </div>
        </div>
