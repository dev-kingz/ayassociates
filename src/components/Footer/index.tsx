...
export function Footer() {
  return (
    <footer className="Footer flex w-full flex-col text-white mt-96 sm:mt-52">
      <section className="TopSection relative flex flex-col-reverse md:flex-row md:justify-between md:items-center pb-10 sm:py-10 sm:px-36 bg-gradient-to-br from-lime-700 via-lime-800 to-secondary">
        <div className="flex flex-col self-stretch items-center sm:items-start gap-6 md:gap-12 px-8">
          ...
          <Link href="/">
            <Button
              variant="secondary"
              size="lg"
              className="bg-white rounded-full text-secondary hover:bg-white/90 transition-colors duration-300 font-medium px-6 py-3"
            >
              Instant Callback
            </Button>
          </Link>
